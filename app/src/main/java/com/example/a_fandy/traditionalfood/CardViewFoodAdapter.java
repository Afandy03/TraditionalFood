...
public class CardViewFoodAdapter extends RecyclerView.Adapter<CardViewFoodAdapter.CardViewViewHolder> {
    ...
    @NonNull
    @Override
    public CardViewFoodAdapter.CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    public void onBindViewHolder(@NonNull CardViewFoodAdapter.CardViewViewHolder cardViewViewHolder, int i) {
        ...
        cardViewViewHolder.btnShare.setOnClickListener(new CustomOnItemClickListener(i, new CustomOnItemClickListener.OnItemClickCallback() {
            @Override
            public void onItemClicked(View view, int position) {
                Toast.makeText(context, "Order "+getListFood().get(position).getName(), Toast.LENGTH_SHORT).show();
            }
        }));
    }
